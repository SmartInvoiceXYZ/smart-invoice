...
// @ts-expect-error TS(6142): Module '../../components/instant/FormConfirmation'... Remove this comment to see the full error message
import { FormConfirmation } from '../../components/instant/FormConfirmation';
// @ts-expect-error TS(6142): Module '../../components/instant/PaymentDetailsFor... Remove this comment to see the full error message
import { InstantPaymentDetailsForm } from '../../components/instant/PaymentDetailsForm';
// @ts-expect-error TS(6142): Module '../../components/instant/ProjectDetailsFor... Remove this comment to see the full error message
