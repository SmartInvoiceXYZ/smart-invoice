...
import { ChainId, ESCROW_STEPS, INSTANT_STEPS, INVOICE_TYPES } from '../constants';
import {
...
export function CreateContextProvider({
  ...
  const RESOLVERS = getResolvers(chainId as ChainId);
  const WRAPPED_NATIVE_TOKEN = getWrappedNativeToken(chainId as ChainId);
  ...
  const createInvoice = useCallback(async () => {
    ...
    if (allValid && detailsHash) {
      ...
      const factoryAddress = getInvoiceFactoryAddress(chainId as ChainId);
