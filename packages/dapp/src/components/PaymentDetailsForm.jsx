    ...
    return (
        <section className='payment-details-form'>
            ...
            <div className='parallel-inputs'>
                ...
                <div className='ordered-inputs'>
                    <p id='arb-fee-desc'>LexDAO deducts a 5% arbitration fee from remaining funds in the case of dispute</p>
                </div>
            </div>
            <sl-checkbox>I agree to LexDAO <a href="">terms of service</a></sl-checkbox>
        </section>
    );
}
