...
describe("SmartInvoiceEscrowV2", function () {
  ...
  beforeEach(async function () {
    ...
    let _terminationTime = 1667606400;
    let _details = EMPTY_BYTES32;
    let _requireVerification = true;
    const implementationData = ethers.utils.AbiCoder.prototype.encode(
      ["uint8", "address", "uint256", "bytes32", "bool"],
      [_resolverType, _token, _terminationTime, _details, _requireVerification],
    );
