...
describe("SmartInvoice", function() {
  ...
  beforeEach(async function() {
    ...
    MockWrappedTokenFactory = await ethers.getContractFactory("MockWETH");
    mockWrappedNativeToken = await MockWrappedTokenFactory.deploy();

    MockArbitratorFactory = await ethers.getContractFactory("MockArbitrator");
  ...
  it("Should revert lock if locked", async () => {
    const lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
    ...
    let receipt = lockedInvoice["lock(bytes32)"](EMPTY_BYTES32);
  ...
  it("Should revert resolver if not individual", async () => {
  ...
  it("Should resolve and not transfer if 0 clientAward", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should resolve and not transfer if 0 providerAward", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should resolve and not transfer if 0 resolutionFee", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should revert rule if not arbitrable", async () => {
  ...
  it("Should revert rule if not locked", async () => {
    const arbitrableInvoice = await SmartInvoice.deploy(
      client.address,
      provider.address,
      arbitratorResolverType,
  ...
  it("Should revert rule if not resolver", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should revert rule if invalid disputeId", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should revert rule if balance is 0", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 1:1 for ruling 0", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 1:0 for ruling 1", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 3:1 for ruling 2", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 1:1 for ruling 3", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 1:3 for ruling 4", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should rule 0:1 for ruling 5", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
  ...
  it("Should revert receive if not wrappedNativeToken", async () => {
  ...
  it("Should revert receive if locked", async () => {
    let lockedInvoice = await getLockedInvoice(
      SmartInvoice,
      client,
      provider,
