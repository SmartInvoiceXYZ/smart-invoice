...
describe('SmartInvoiceUpdatable', function () {
  ...
  let invoice: ContractTypesMap['SmartInvoiceUpdatable'];
  let mockToken: Hex;
  ...
  beforeEach(async function () {
    ...
    invoice = await viem.getContractAt('SmartInvoiceUpdatable', address!);
  ...
  it('Should revert init if invalid provider receiver', async function () {
    ...
    await expect(receipt).to.be.revertedWith('invalid provider receiver');
  });
